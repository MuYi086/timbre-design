...
- 分组：human（人类/常规人物）
- 档案：female（女声） / middle_aged（中年） / human（人类/常规人物） / zh-CN
- 声音质感：dry_clear（dry=干声/干涩, clear=清晰）
- 默认语气：efficient（干练高效）
- 适配角色：professional_female（professional=职业化, female=女声）
- 不推荐场景：childlike_role（childlike=孩童感, role=角色）
- 备注：无
