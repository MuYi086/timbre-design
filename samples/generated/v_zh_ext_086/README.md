...
- 声音质感：low_mid（low=低, mid=中频）、airy_light（airy=气声/空灵, light=轻亮）
- 默认语气：mysterious（神秘）
- 适配角色：antihero（反英雄）、inner_monologue_male（inner=内心, monologue=独白, male=男声）
- 不推荐场景：high_volume_speech（high=高, volume=音量, speech=演讲/语音）
- 备注：轻气声男中低频。
