...
- 分组：human（人类/常规人物）
- 档案：female（女声） / senior（老年） / human（人类/常规人物） / zh-CN
- 声音质感：ritual_old（ritual=仪式, old=老年/旧式）
- 默认语气：mystic（神秘/玄秘）
- 适配角色：shaman_old_woman（shaman=神婆/巫者, old=老年/旧式, woman=女性）
- 不推荐场景：news_broadcast（news=新闻, broadcast=播报）
- 备注：无
