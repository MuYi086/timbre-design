...
- 分组：human（人类/常规人物）
- 档案：male（男声） / senior（老年） / human（人类/常规人物） / zh-CN
- 声音质感：mystic_old（mystic=神秘/玄秘, old=老年/旧式）
- 默认语气：cryptic（隐晦神秘）
- 适配角色：prophet_old_man（prophet=预言者, old=老年/旧式, man=男性）
- 不推荐场景：modern_office_scene（modern=现代, office=办公室/职场, scene=场景）
- 备注：无
