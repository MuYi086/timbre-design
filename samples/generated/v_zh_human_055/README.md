...
- 分组：human（人类/常规人物）
- 档案：male（男声） / teen（少年/少女） / human（人类/常规人物） / zh-CN
- 声音质感：soft_young（soft=柔和, young=年轻）
- 默认语气：introvert（内向）
- 适配角色：sensitive_boy（sensitive=敏感, boy=男孩）
- 不推荐场景：rally_speech（rally=动员, speech=演讲/语音）
- 备注：无
